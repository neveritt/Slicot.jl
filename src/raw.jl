...
function ab01md!(JOBZ::Char, N::Integer, A::Array{Float64,2},
    ...
    TAU::Array{Float64,1}, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab01md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ab01nd!(JOBZ::Char, N::Integer, M::Integer,
    ...
    ccall((:ab01nd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ab01od!(STAGES::Char, JOBU::Char, JOBV::Char, N::Integer,
    ...
    INDCON::Integer, KSTAIR::Array{BlasInt,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab01od_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function ab04md!(TYPE::Char, N::Integer, M::Integer, P::Integer,
    ALPHA::AbstractFloat, BETA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    ...
    ccall((:ab04md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ab05md!(UPLO::Char, OVER::Char, N1::Integer, M1::Integer,
    ...
    ccall((:ab05md_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab05nd!(OVER::Char, N1::Integer, M1::Integer, P1::Integer,
    N2::Integer, ALPHA::AbstractFloat, A1::Array{Float64,2},
    LDA1::Integer, B1::Array{Float64,2}, LDB1::Integer,
    C1::Array{Float64,2}, LDC1::Integer,
    D1::Array{Float64,2}, LDD1::Integer,
    A2::Array{Float64,2}, LDA2::Integer,
    ...
    ccall((:ab05nd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ab05od!(OVER::Char, N1::Integer, M1::Integer, P1::Integer,
    N2::Integer, M2::Integer, ALPHA::AbstractFloat,
    ...
    ccall((:ab05od_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function ab05pd!(OVER::Char, N1::Integer, M::Integer, P::Integer,
    ...
    ccall((:ab05pd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab05qd!(OVER::Char, N1::Integer, M1::Integer, P1::Integer,
    ...
    ccall((:ab05qd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab05rd!(FBTYPE::Char, JOBD::Char, N::Integer, M::Integer,
    P::Integer, MV::Integer, PZ::Integer, ALPHA::AbstractFloat,
    BETA::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer,
    ...
    H::Array{Float64,2}, LDH::Integer, RCOND::AbstractFloat,
    ...
    ccall((:ab05rd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function ab05sd!(FBTYPE::Char, JOBD::Char, N::Integer, M::Integer,
    P::Integer, ALPHA::AbstractFloat, A::Array{Float64,2},
    LDA::Integer, B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer,
    F::Array{Float64,2}, LDF::Integer, RCOND::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab05sd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab07md!(JOBD::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:ab07md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab07nd!(N::Integer, M::Integer, A::Array{Float64,2},
    LDA::Integer, B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer, RCOND::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab07nd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab08md!(EQUIL::Char, N::Integer, M::Integer, P::Integer,
    ...
    TOL::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab08md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function ab08mz!(EQUIL::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:ab08mz_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ab08nd!(EQUIL::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:ab08nd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab08nx!(N::Integer, M::Integer, P::Integer, RO::Integer,
    SIGMA::Integer, SVLMAX::AbstractFloat,
    ABCD::Array{Float64,2}, LDABCD::Integer, NINFZ::Integer,
    INFZ::Array{BlasInt,1}, KRONL::Array{BlasInt,1}, MU::Integer,
    NU::Integer, NKROL::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab08nx_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab08nz!(EQUIL::Char, N::Integer, M::Integer, P::Integer,
    ...
    BF::Array{Complex,2}, LDBF::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    ZWORK::Array{Complex,1}, LZWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab08nz_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Complex128},
            Ptr{BlasInt}, Ptr{Complex128}, Ptr{BlasInt},
            Ptr{Complex128}, Ptr{BlasInt}, Ptr{Complex128},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function ab09ad!(DICO::Char, JOB::Char, EQUIL::Char, ORDSEL::Char,
    ...
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    HSV::Array{Float64,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ab09ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function ab09ax!(DICO::Char, JOB::Char, ORDSEL::Char, N::Integer,
    ...
    ccall((:ab09ax_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function ab09bd!(DICO::Char, JOB::Char, EQUIL::Char, ORDSEL::Char,
    ...
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer,
    HSV::Array{Float64,1}, TOL1::AbstractFloat,
    TOL2::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ab09bd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function ab09bx!(DICO::Char, JOB::Char, ORDSEL::Char, N::Integer,
    ...
    HSV::Array{Float64,1}, T::Array{Float64,2},
    LDT::Integer, TI::Array{Float64,2}, LDTI::Integer,
    TOL1::AbstractFloat, TOL2::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ab09bx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab09cd!(DICO::Char, EQUIL::Char, ORDSEL::Char, N::Integer,
    ...
    ccall((:ab09cd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function ab09cx!(DICO::Char, ORDSEL::Char, N::Integer, M::Integer,
    ...
    ccall((:ab09cx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab09dd!(DICO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:ab09dd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab09ed!(DICO::Char, EQUIL::Char, ORDSEL::Char, N::Integer,
    M::Integer, P::Integer, NR::Integer, ALPHA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    ...
    ccall((:ab09ed_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function ab09fd!(DICO::Char, JOBCF::Char, FACT::Char, JOBMR::Char,
    ...
    NR::Integer, ALPHA::AbstractFloat, A::Array{Float64,2},
    LDA::Integer, B::Array{Float64,2}, LDB::Integer,
    ...
    ccall((:ab09fd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function ab09gd!(DICO::Char, JOBCF::Char, FACT::Char, JOBMR::Char,
    ...
    HSV::Array{Float64,1}, TOL1::AbstractFloat,
    TOL2::AbstractFloat, TOL3::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ab09gd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab09hd!(DICO::Char, JOB::Char, EQUIL::Char, ORDSEL::Char,
    ...
    ccall((:ab09hd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab09hx!(DICO::Char, JOB::Char, ORDSEL::Char, N::Integer,
    ...
    ccall((:ab09hx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function ab09hy!(N::Integer, M::Integer, P::Integer,
    ...
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer, SCALEC::AbstractFloat,
    SCALEO::AbstractFloat, S::Array{Float64,2}, LDS::Integer,
    ...
    ccall((:ab09hy_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function ab09id!(DICO::Char, JOBC::Char, JOBO::Char, JOB::Char,
    ...
    NR::Integer, ALPHA::AbstractFloat, ALPHAC::AbstractFloat,
    ALPHAO::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer,
    ...
    ccall((:ab09id_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function ab09ix!(DICO::Char, JOB::Char, FACT::Char, ORDSEL::Char,
    N::Integer, M::Integer, P::Integer, NR::Integer,
    SCALEC::AbstractFloat, SCALEO::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer,
    ...
    ccall((:ab09ix_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab09iy!(DICO::Char, JOBC::Char, JOBO::Char, WEIGHT::Char,
    ...
    NW::Integer, MW::Integer, ALPHAC::AbstractFloat,
    ALPHAO::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    AV::Array{Float64,2}, LDAV::Integer,
    ...
    BW::Array{Float64,2}, LDBW::Integer,
    CW::Array{Float64,2}, LDCW::Integer,
    DW::Array{Float64,2}, LDDW::Integer, SCALEC::AbstractFloat,
    SCALEO::AbstractFloat, S::Array{Float64,2}, LDS::Integer,
    ...
    ccall((:ab09iy_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab09jd!(JOBV::Char, JOBW::Char, JOBINV::Char, DICO::Char,
    ...
    ccall((:ab09jd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab09jv!(JOB::Char, DICO::Char, JOBEV::Char, STBCHK::Char,
    ...
    ccall((:ab09jv_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab09jw!(JOB::Char, DICO::Char, JOBEW::Char, STBCHK::Char,
    ...
    ccall((:ab09jw_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ab09jx!(DICO::Char, STDOM::Char, EVTYPE::Char, N::Integer,
    ALPHA::AbstractFloat, ER::Array{Float64,1},
    EI::Array{Float64,1}, ED::Array{Float64,1},
    TOLINF::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:ab09jx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function ab09kd!(JOB::Char, DICO::Char, WEIGHT::Char, EQUIL::Char,
    ...
    P::Integer, NR::Integer, ALPHA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer,
    ...
    ccall((:ab09kd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function ab09kx!(JOB::Char, DICO::Char, WEIGHT::Char, N::Integer,
    ...
    ccall((:ab09kx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ab09md!(DICO::Char, JOB::Char, EQUIL::Char, ORDSEL::Char,
    N::Integer, M::Integer, P::Integer, NR::Integer,
    ALPHA::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    ...
    ccall((:ab09md_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function ab09nd!(DICO::Char, JOB::Char, EQUIL::Char, ORDSEL::Char,
    ...
    ccall((:ab09nd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function ab13dd!(DICO::Char, JOBE::Char, EQUIL::Char, JOBD::Char,
    ...
    A::Array{Float64,1}, LDA::AbstractFloat,
    E::Array{Float64,1}, LDE::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    GPEAK::Array{Float64,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, CWORK::Array{Complex,1}, LCWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab13dd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function ab13ed!(N::Integer, A::Array{Float64,2}, LDA::Integer,
    LOW::AbstractFloat, HIGH::AbstractFloat, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab13ed_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function ab13fd!(N::Integer, A::Array{Float64,2}, LDA::Integer,
    BETA::AbstractFloat, OMEGA::AbstractFloat, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer,
    CWORK::Array{Complex,1}, LCWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ab13fd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function ab13md!(FACT::Char, N::Integer, Z::Array{Complex,1},
    ...
    BOUND::AbstractFloat, D::Array{Float64,1},
    ...
    ccall((:ab13md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ab8nxz!(N::Integer, M::Integer, P::Integer, RO::Integer,
    SIGMA::Integer, SVLMAX::AbstractFloat, ABCD::Array{Complex,2},
    ...
    ccall((:ab8nxz_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function ag07bd!(JOBE::Char, N::Integer, M::Integer,
    ...
    ccall((:ag07bd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ag08bd!(EQUIL::Char, L::Integer, N::Integer, M::Integer,
    ...
    KRONL::Array{BlasInt,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:ag08bd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function ag08by!(FIRST::Bool, N::Integer, M::Integer, P::Integer,
    SVLMAX::AbstractFloat, ABCD::Array{Float64,1},
    LDABCD::AbstractFloat, E::Array{Float64,1},
    LDE::AbstractFloat, NR::Integer, PR::Integer, NINFZ::Integer,
    ...
    ccall((:ag08by_, libslicotpath), Void, (Ptr{Bool}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ag08bz!(EQUIL::Char, L::Integer, N::Integer, M::Integer,
    ...
    ccall((:ag08bz_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ag8byz!(FIRST::Bool, N::Integer, M::Integer, P::Integer,
    SVLMAX::AbstractFloat, ABCD::Array{Complex,1}, LDABCD::Complex,
    ...
    ccall((:ag8byz_, libslicotpath), Void, (Ptr{Bool}, Ptr{BlasInt},
...
function de01od!(CONV::Char, N::Integer, A::Array{Float64,1},
    ...
    ccall((:de01od_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function de01pd!(CONV::Char, WGHT::Char, N::Integer,
    ...
    ccall((:de01pd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function df01md!(SICO::Char, N::Integer, DT::AbstractFloat,
    A::Array{Float64,1}, DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:df01md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function dg01md!(INDI::Char, N::Integer, XR::Array{Float64,1},
    ...
    ccall((:dg01md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function dg01nd!(INDI::Char, N::Integer, XR::Array{Float64,1},
    ...
    ccall((:dg01nd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}), &INDI, &N,
            XR, XI, INFO)
...
function dg01ny!(INDI::Char, N::Integer, XR::Array{Float64,1},
    ...
    ccall((:dg01ny_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function dg01od!(SCR::Char, WGHT::Char, N::Integer,
    ...
    ccall((:dg01od_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
            &SCR, &WGHT, &N, A, W, INFO)
...
function dk01md!(TYPE::Char, N::Integer, A::Array{Float64,1})
    ...
    ccall((:dk01md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function fb01qd!(JOBK::Char, MULTBQ::Char, N::Integer, M::Integer,
    ...
    C::Array{Float64,2}, LDC::Integer,
    R::Array{Float64,2}, LDR::Integer,
    K::Array{Float64,2}, LDK::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:fb01qd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function fb01rd!(JOBK::Char, MULTBQ::Char, N::Integer, M::Integer,
    ...
    ccall((:fb01rd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function fb01sd!(JOBX::Char, MULTAB::Char, MULTRC::Char, N::Integer,
    ...
    ccall((:fb01sd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function fb01td!(JOBX::Char, MULTRC::Char, N::Integer, M::Integer,
    ...
    ccall((:fb01td_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function fb01vd!(N::Integer, M::Integer, L::Integer,
    ...
    ccall((:fb01vd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function fd01ad!(JP::Char, L::Integer, LAMBDA::AbstractFloat,
    XIN::AbstractFloat, YIN::AbstractFloat, EFOR::AbstractFloat,
    XF::Array{Float64,1}, EPSBCK::Array{Float64,1},
    CTETA::Array{Float64,1}, STETA::Array{Float64,1},
    YQ::Array{Float64,1}, EPOS::AbstractFloat,
    EOUT::AbstractFloat, SALPH::Array{Float64,1},
    IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:fd01ad_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function ib01ad!(METH::Char, ALG::Char, JOBD::Char, BATCH::Char,
    ...
    SV::Array{Float64,1}, RCOND::AbstractFloat,
    TOL::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib01ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ib01bd!(METH::Char, JOB::Char, JOBCK::Char, NOBR::Integer,
    ...
    K::Array{Float64,1}, LDK::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, BWORK::Array{Bool,1}, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib01bd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ib01cd!(JOBX0::Char, COMUSE::Char, JOB::Char, N::Integer,
    ...
    LDV::Integer, TOL::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib01cd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ib01md!(METH::Char, ALG::Char, BATCH::Char, CONCT::Char,
    ...
    ccall((:ib01md_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function ib01my!(METH::Char, BATCH::Char, CONCT::Char, NOBR::Integer,
    ...
    ccall((:ib01my_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function ib01nd!(METH::Char, JOBD::Char, NOBR::Integer, M::Integer,
    ...
    SV::Array{Float64,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib01nd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function ib01od!(CTRL::Char, NOBR::Integer, L::Integer,
    SV::Array{Float64,1}, N::Integer, TOL::AbstractFloat,
    IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib01od_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ib01oy!(NS::Integer, NMAX::Integer, N::Integer,
    ...
    ccall((:ib01oy_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
...
function ib01pd!(METH::Char, JOB::Char, JOBCV::Char, NOBR::Integer,
    ...
    RY::Array{Float64,1}, LDRY::Integer,
    S::Array{Float64,1}, LDS::Integer,
    O::Array{Float64,1}, LDO::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib01pd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ib01px!(JOB::Char, NOBR::Integer, N::Integer, M::Integer,
    ...
    ccall((:ib01px_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ib01py!(METH::Char, JOB::Char, NOBR::Integer, N::Integer,
    ...
    B::Array{Float64,1}, LDB::Integer,
    D::Array{Float64,1}, LDD::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib01py_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ib01qd!(JOBX0::Char, JOB::Char, N::Integer, M::Integer,
    ...
    ccall((:ib01qd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ib01rd!(JOB::Char, N::Integer, M::Integer, L::Integer,
    ...
    U::Array{Float64,1}, LDU::Integer,
    Y::Array{Float64,1}, LDY::Integer,
    X0::Array{Float64,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib01rd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ib03ad!(INIT::Char, ALG::Char, STOR::Char, NOBR::Integer,
    ...
    U::Array{Float64,1}, LDU::Integer,
    Y::Array{Float64,1}, LDY::Integer,
    X::Array{Float64,1}, LX::Integer, TOL1::AbstractFloat,
    TOL2::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:ib03ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ib03bd!(INIT::Char, NOBR::Integer, M::Integer, L::Integer,
    ...
    ccall((:ib03bd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function ma01ad!(XR::AbstractFloat, XI::AbstractFloat,
    YR::AbstractFloat, YI::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:ma01ad_, libslicotpath), Void, (Ptr{Float64}, Ptr{Float64},
...
function ma01bd!(BASE::AbstractFloat, LGBAS::AbstractFloat,
    K::Integer, S::Array{BlasInt,1}, A::Array{Float64,1},
    INCA::Integer, ALPHA::AbstractFloat, BETA::AbstractFloat,
    SCAL::Integer)

    INFO = BlasInt[0]

    ccall((:ma01bd_, libslicotpath), Void, (Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function ma02ad!(JOB::Char, M::Integer, N::Integer,
    ...
    ccall((:ma02ad_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function ma02bd!(SIDE::Char, M::Integer, N::Integer,
    ...
    ccall((:ma02bd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ma02bz!(SIDE::Char, M::Integer, N::Integer,
    ...
    ccall((:ma02bz_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ma02cd!(N::Integer, KL::Integer, KU::Integer,
    ...
    ccall((:ma02cd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
...
function ma02cz!(N::Integer, KL::Integer, KU::Integer,
    ...
    ccall((:ma02cz_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
...
function ma02dd!(JOB::Char, UPLO::Char, N::Integer,
    ...
    ccall((:ma02dd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}),
            &JOB, &UPLO, &N, A, &LDA, AP)
...
function ma02ed!(UPLO::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:ma02ed_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function ma02fd!(X1::AbstractFloat, X2::AbstractFloat,
    C::AbstractFloat, S::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:ma02fd_, libslicotpath), Void, (Ptr{Float64}, Ptr{Float64},
...
function ma02gd!(N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, K1::Integer, K2::Integer,
    IPIV::Array{BlasInt,1}, INCX::Integer)

    INFO = BlasInt[0]

    ccall((:ma02gd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function mb01kd!(UPLO::Char, TRANS::Char, N::Integer, K::Integer,
    ALPHA::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer, BETA::AbstractFloat,
    C::Array{Float64,2}, LDC::Integer)

    INFO = BlasInt[0]

    ccall((:mb01kd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb01ld!(UPLO::Char, TRANS::Char, M::Integer, N::Integer,
    ...
    ccall((:mb01ld_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb01md!(UPLO::Char, N::Integer, ALPHA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    X::Array{Float64,1}, INCX::Integer, BETA::AbstractFloat,
    Y::Array{Float64,1}, INCY::Integer)

    INFO = BlasInt[0]

    ccall((:mb01md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb01nd!(UPLO::Char, N::Integer, ALPHA::AbstractFloat,
    ...
    ccall((:mb01nd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb01pd!(SCUN::Char, TYPE::Char, M::Integer, N::Integer,
    KL::Integer, KU::Integer, ANRM::AbstractFloat, NBL::Integer,
    NROWS::Integer, A::Array{Float64,1}, LDA::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb01pd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function mb01qd!(TYPE::Char, M::Integer, N::Integer, KL::Integer,
    KU::Integer, CFROM::AbstractFloat, CTO::AbstractFloat,
    NBL::Integer, NROWS::Integer, A::Array{Float64,1},
    LDA::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb01qd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function mb01rd!(UPLO::Char, TRANS::Char, M::Integer, N::Integer,
    ...
    ccall((:mb01rd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}), &UPLO, &TRANS, &M, &N, &ALPHA, &BETA, R,
...
function mb01ru!(UPLO::Char, TRANS::Char, M::Integer, N::Integer,
    ...
    ccall((:mb01ru_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}), &UPLO, &TRANS, &M, &N, &ALPHA, &BETA, R,
...
function mb01rw!(UPLO::Char, TRANS::Char, M::Integer, N::Integer,
    ...
    ccall((:mb01rw_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb01rx!(SIDE::Char, UPLO::Char, TRANS::Char, M::Integer,
    N::Integer, ALPHA::AbstractFloat, BETA::AbstractFloat,
    R::Array{Float64,2}, LDR::Integer,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer)
    ...
    ccall((:mb01rx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb01ry!(SIDE::Char, UPLO::Char, TRANS::Char, M::Integer,
    ...
    ccall((:mb01ry_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb01sd!(JOBS::Char, M::Integer, N::Integer,
    ...
    ccall((:mb01sd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb01td!(N::Integer, A::Array{Float64,2}, LDA::Integer,
    ...
    ccall((:mb01td_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb01ud!(SIDE::Char, TRANS::Char, M::Integer, N::Integer,
    ALPHA::AbstractFloat, H::Array{Float64,2}, LDH::Integer,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer)

    INFO = BlasInt[0]

    ccall((:mb01ud_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb01uw!(SIDE::Char, TRANS::Char, M::Integer, N::Integer,
    ...
    ccall((:mb01uw_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &SIDE, &TRANS, &M, &N,
...
function mb01ux!(SIDE::Char, UPLO::Char, TRANS::Char, M::Integer,
    N::Integer, ALPHA::AbstractFloat, T::Array{Float64,2},
    LDT::Integer, A::Array{Float64,2}, LDA::Integer,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb01ux_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb01vd!(TRANA::Char, TRANB::Char, MA::Integer, NA::Integer,
    MB::Integer, NB::Integer, ALPHA::AbstractFloat,
    BETA::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    ...
    ccall((:mb01vd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb01wd!(DICO::Char, UPLO::Char, TRANS::Char, HESS::Char,
    ...
    ccall((:mb01wd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function mb01xd!(UPLO::Char, N::Integer, A::Array{Float64,1},
    ...
    ccall((:mb01xd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function mb01xy!(UPLO::Char, N::Integer, A::Array{Float64,1},
    ...
    ccall((:mb01xy_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}), &UPLO, &N, A,
            &LDA, INFO)
...
function mb01yd!(UPLO::Char, TRANS::Char, N::Integer, K::Integer,
    L::Integer, ALPHA::AbstractFloat, BETA::AbstractFloat,
    A::Array{Float64,1}, LDA::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb01yd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb01zd!(SIDE::Char, UPLO::Char, TRANST::Char, DIAG::Char,
    M::Integer, N::Integer, L::Integer, ALPHA::AbstractFloat,
    T::Array{Float64,1}, LDT::AbstractFloat,
    H::Array{Float64,1}, LDH::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb01zd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb02cd!(JOB::Char, TYPET::Char, K::Integer, N::Integer,
    ...
    ccall((:mb02cd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02cu!(TYPEG::Char, K::Integer, P::Integer, Q::Integer,
    ...
    TOL::AbstractFloat, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb02cu_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function mb02cv!(TYPEG::Char, STRUCG::Char, K::Integer, N::Integer,
    ...
    ccall((:mb02cv_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02cx!(TYPET::Char, P::Integer, Q::Integer, K::Integer,
    ...
    ccall((:mb02cx_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02cy!(TYPET::Char, STRUCG::Char, P::Integer, Q::Integer,
    ...
    ccall((:mb02cy_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02dd!(JOB::Char, TYPET::Char, K::Integer, M::Integer,
    ...
    ccall((:mb02dd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb02ed!(TYPET::Char, K::Integer, N::Integer, NRHS::Integer,
    ...
    ccall((:mb02ed_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02fd!(TYPET::Char, K::Integer, N::Integer, P::Integer,
    ...
    ccall((:mb02fd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb02gd!(TYPET::Char, TRIU::Char, K::Integer, N::Integer,
    ...
    ccall((:mb02gd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb02hd!(TRIU::Char, K::Integer, L::Integer, M::Integer,
    ...
    ccall((:mb02hd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb02id!(JOB::Char, K::Integer, L::Integer, M::Integer,
    ...
    ccall((:mb02id_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb02jd!(JOB::Char, K::Integer, L::Integer, M::Integer,
    ...
    ccall((:mb02jd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb02jx!(JOB::Char, K::Integer, L::Integer, M::Integer,
    ...
    TOL1::AbstractFloat, TOL2::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb02jx_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb02kd!(LDBLK::Char, TRANS::Char, K::Integer, L::Integer,
    M::Integer, N::Integer, R::Integer, ALPHA::AbstractFloat,
    BETA::AbstractFloat, TC::Array{Float64,2}, LDTC::Integer,
    TR::Array{Float64,2}, LDTR::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    DWORK::Array{Float64,1}, LDWORK::Integer)
    ...
    ccall((:mb02kd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb02md!(JOB::Char, M::Integer, N::Integer, L::Integer,
    ...
    LDX::Integer, TOL::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:mb02md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02nd!(M::Integer, N::Integer, L::Integer, RANK::Integer,
    THETA::AbstractFloat, C::Array{Float64,2}, LDC::Integer,
    X::Array{Float64,2}, LDX::Integer,
    Q::Array{Float64,1}, INUL::Array{Bool,1},
    TOL::AbstractFloat, RELTOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, BWORK::Array{Bool,1}, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:mb02nd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb02ny!(UPDATU::Bool, UPDATV::Bool, M::Integer, N::Integer,
    ...
    ccall((:mb02ny_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02od!(SIDE::Char, UPLO::Char, TRANS::Char, DIAG::Char,
    NORM::Char, M::Integer, N::Integer, ALPHA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer, RCOND::AbstractFloat,
    TOL::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb02od_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb02pd!(FACT::Char, TRANS::Char, N::Integer, NRHS::Integer,
    A::Array{Float64,1}, LDA::AbstractFloat,
    AF::Array{Float64,1}, LDAF::AbstractFloat,
    IPIV::Array{BlasInt,1}, EQUED::Char, R::Array{Float64,1},
    C::Array{Float64,1}, B::Array{Float64,1},
    LDB::AbstractFloat, X::Array{Float64,1}, LDX::AbstractFloat,
    RCOND::AbstractFloat, FERR::Array{Float64,1},
    BERR::Array{Float64,1}, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb02pd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb02qd!(JOB::Char, INIPER::Char, M::Integer, N::Integer,
    NRHS::Integer, RCOND::AbstractFloat, SVLMAX::AbstractFloat,
    A::Array{Float64,1}, LDA::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat, Y::AbstractFloat,
    ...
    ccall((:mb02qd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb02qy!(M::Integer, N::Integer, NRHS::Integer, RANK::Integer,
    ...
    LDB::AbstractFloat, TAU::Array{Float64,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb02qy_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb02rd!(TRANS::Char, N::Integer, NRHS::Integer,
    ...
    ccall((:mb02rd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02rz!(TRANS::Char, N::Integer, NRHS::Integer,
    ...
    ccall((:mb02rz_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function mb02sd!(N::Integer, H::Array{Float64,2}, LDH::Integer,
    ...
    ccall((:mb02sd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
...
function mb02sz!(N::Integer, H::Array{Complex,2}, LDH::Integer,
    ...
    ccall((:mb02sz_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Complex128},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}), &N, H, &LDH,
            IPIV, INFO)
...
function mb02td!(NORM::Char, N::Integer, HNORM::AbstractFloat,
    H::Array{Float64,1}, LDH::AbstractFloat,
    IPIV::Array{BlasInt,1}, RCOND::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb02td_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb02tz!(NORM::Char, N::Integer, HNORM::AbstractFloat,
    H::Array{Complex,1}, LDH::Complex, IPIV::Array{BlasInt,1},
    RCOND::AbstractFloat, DWORK::Array{Float64,1},
    ZWORK::Array{Complex,1})

    INFO = BlasInt[0]

    ccall((:mb02tz_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function mb02ud!(FACT::Char, SIDE::Char, TRANS::Char, JOBP::Char,
    M::Integer, N::Integer, ALPHA::AbstractFloat,
    RCOND::AbstractFloat, RANK::Integer, R::Array{Float64,2},
    ...
    ccall((:mb02ud_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02uu!(N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, RHS::Array{Float64,1},
    IPIV::Array{BlasInt,1}, JPIV::Array{BlasInt,1},
    SCALE::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb02uu_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function mb02uv!(N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, IPIV::Array{BlasInt,1},
    JPIV::Array{BlasInt,1})

    INFO = BlasInt[0]

    ccall((:mb02uv_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb02uw!(LTRANS::Bool, N::Integer, M::Integer,
    ...
    LDA::AbstractFloat, B::Array{Float64,1}, LDB::AbstractFloat,
    SCALE::AbstractFloat, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:mb02uw_, libslicotpath), Void, (Ptr{Bool}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb02vd!(TRANS::Char, M::Integer, N::Integer,
    ...
    ccall((:mb02vd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb02yd!(COND::Char, N::Integer, R::Array{Float64,2},
    ...
    RANK::Integer, X::Array{Float64,1}, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb02yd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb03ad!(SHFT::Char, K::Integer, N::Integer,
    ...
    C1::AbstractFloat, S1::AbstractFloat, C2::AbstractFloat,
    S2::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb03ad_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function mb03ba!(K::Integer, H::Integer, S::Array{BlasInt,1},
    ...
    ccall((:mb03ba_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb03bb!(BASE::AbstractFloat, LGBAS::AbstractFloat,
    ULP::AbstractFloat, K::Integer, AMAP::Array{BlasInt,1},
    ...
    ccall((:mb03bb_, libslicotpath), Void, (Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03bc!(K::Integer, AMAP::Array{BlasInt,1},
    ...
    ccall((:mb03bc_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03bd!(JOB::Char, DEFL::Char, COMPQ::Char,
    ...
    ccall((:mb03bd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb03be!(K::Integer, AMAP::Array{BlasInt,1},
    ...
    ccall((:mb03be_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03cd!(UPLO::Char, N1::Integer, N2::Integer,
    PREC::AbstractFloat, A::Array{Float64,1},
    LDA::AbstractFloat, B::Array{Float64,1}, LDB::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    Q1::Array{Float64,1}, LDQ1::AbstractFloat,
    Q2::Array{Float64,1}, LDQ2::AbstractFloat,
    Q3::Array{Float64,1}, LDQ3::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb03cd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03dd!(UPLO::Char, N1::Integer, N2::Integer,
    ...
    ccall((:mb03dd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}), &UPLO, &N1, &N2, &PREC, A, &LDA, B, &LDB,
...
function mb03ed!(N::Integer, PREC::AbstractFloat,
    A::Array{Float64,1}, LDA::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    Q1::Array{Float64,1}, LDQ1::AbstractFloat,
    ...
    ccall((:mb03ed_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03fd!(N::Integer, PREC::AbstractFloat,
    A::Array{Float64,1}, LDA::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    Q1::Array{Float64,1}, LDQ1::AbstractFloat,
    Q2::Array{Float64,1}, LDQ2::AbstractFloat,
    ...
    ccall((:mb03fd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}), &N, &PREC, A,
...
function mb03gd!(N::Integer, B::Array{Float64,1},
    LDB::AbstractFloat, D::Array{Float64,1}, LDD::AbstractFloat,
    MACPAR::Array{Float64,1}, Q::Array{Float64,1},
    LDQ::AbstractFloat, U::Array{Float64,1}, LDU::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb03gd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03hd!(N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, B::Array{Float64,1}, LDB::AbstractFloat,
    MACPAR::Array{Float64,1}, Q::Array{Float64,1},
    LDQ::AbstractFloat, DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb03hd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb03id!(COMPQ::Char, COMPU::Char, N::Integer,
    ...
    D::Array{Float64,1}, LDD::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    F::Array{Float64,1}, LDF::AbstractFloat,
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    U1::Array{Float64,1}, LDU1::AbstractFloat,
    U2::Array{Float64,1}, LDU2::AbstractFloat, NEIG::Integer,
    IWORK::Array{BlasInt,1}, LIWORK::Integer,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb03id_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03jd!(COMPQ::Char, N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, D::Array{Float64,1}, LDD::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    F::Array{Float64,1}, LDF::AbstractFloat,
    Q::Array{Float64,1}, LDQ::AbstractFloat, NEIG::Integer,
    IWORK::Array{BlasInt,1}, LIWORK::Integer,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb03jd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb03ka!(COMPQ::Char, WHICHQ::Array{BlasInt,1}, WS::Bool,
    ...
    ccall((:mb03ka_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function mb03kb!(COMPQ::Char, WHICHQ::Array{BlasInt,1}, WS::Bool,
    ...
    ccall((:mb03kb_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Bool}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function mb03kc!(K::Integer, KHESS::Integer, N::Integer, R::Integer,
    ...
    ccall((:mb03kc_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function mb03kd!(COMPQ::Char, WHICHQ::Array{BlasInt,1}, STRONG::Char,
    ...
    ccall((:mb03kd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function mb03ke!(TRANA::Bool, TRANB::Bool, ISGN::Integer, K::Integer,
    M::Integer, N::Integer, PREC::AbstractFloat, SMIN::AbstractFloat,
    S::Array{BlasInt,1}, A::Array{Float64,1},
    B::Array{Float64,1}, C::Array{Float64,1},
    SCALE::AbstractFloat, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb03ke_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03ld!(COMPQ::Char, ORTH::Char, N::Integer,
    A::Array{Float64,1}, LDA::AbstractFloat,
    DE::Array{Float64,1}, LDDE::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    FG::Array{Float64,1}, LDFG::AbstractFloat, NEIG::Integer,
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    ALPHAR::Array{Float64,1}, ALPHAI::Array{Float64,1},
    ...
    ccall((:mb03ld_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb03md!(N::Integer, L::Integer, THETA::AbstractFloat,
    Q::Array{Float64,1}, E::Array{Float64,1},
    Q2::Array{Float64,1}, E2::Array{Float64,1},
    PIVMIN::AbstractFloat, TOL::AbstractFloat, RELTOL::AbstractFloat,
    IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:mb03md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03od!(JOBQR::Char, M::Integer, N::Integer,
    A::Array{Float64,1}, LDA::AbstractFloat,
    JPVT::Array{BlasInt,1}, RCOND::AbstractFloat,
    SVLMAX::AbstractFloat, TAU::Array{Float64,1}, RANK::Integer,
    SVAL::Array{Float64,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb03od_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb03oy!(M::Integer, N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, RCOND::AbstractFloat, SVLMAX::AbstractFloat,
    ...
    ccall((:mb03oy_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb03pd!(JOBRQ::Char, M::Integer, N::Integer,
    ...
    ccall((:mb03pd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03py!(M::Integer, N::Integer, A::Array{Float64,1},
    ...
    ccall((:mb03py_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}), &M, &N, A, &LDA, &RCOND,
            &SVLMAX, &RANK, SVAL, JPVT, TAU, DWORK, INFO)
...
function mb03qd!(DICO::Char, STDOM::Char, JOBU::Char, N::Integer,
    NLOW::Integer, NSUP::Integer, ALPHA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    ...
    ccall((:mb03qd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb03qx!(N::Integer, T::Array{Float64,1}, LDT::Integer,
    ...
    ccall((:mb03qx_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
            &N, T, &LDT, WR, WI, INFO)
...
function mb03qy!(N::Integer, L::Integer, A::Array{Float64,2},
    ...
    E1::AbstractFloat, E2::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb03qy_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03rd!(JOBX::Char, SORT::Char, N::Integer,
    PMAX::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    X::Array{Float64,2}, LDX::Integer, NBLCKS::Integer,
    BLSIZE::Array{BlasInt,1}, WR::Array{Float64,1},
    WI::Array{Float64,1}, TOL::AbstractFloat,
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb03rd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03rx!(JOBV::Char, N::Integer, KL::Integer, KU::Integer,
    ...
    ccall((:mb03rx_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb03ry!(M::Integer, N::Integer, PMAX::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer)
    ...
    ccall((:mb03ry_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb03sd!(JOBSCL::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:mb03sd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03td!(TYP::Char, COMPU::Char, SELECT::Array{Bool,1},
    ...
    ccall((:mb03td_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function mb03ts!(ISHAM::Bool, WANTU::Bool, N::Integer,
    ...
    ccall((:mb03ts_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function mb03ud!(JOBQ::Char, JOBP::Char, N::Integer,
    ...
    ccall((:mb03ud_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03vd!(N::Integer, P::Integer, ILO::Integer, IHI::Integer,
    A::Array{Float64,1}, LDA1::AbstractFloat,
    LDA2::AbstractFloat, TAU::Array{Float64,1},
    LDTAU::AbstractFloat, DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb03vd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03vy!(N::Integer, P::Integer, ILO::Integer, IHI::Integer,
    ...
    ccall((:mb03vy_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03wa!(WANTQ::Bool, WANTZ::Bool, N1::Integer, N2::Integer,
    ...
    ccall((:mb03wa_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03wd!(JOB::Char, COMPZ::Char, N::Integer, P::Integer,
    ...
    H::Array{Float64,1}, LDH1::AbstractFloat,
    LDH2::AbstractFloat, Z::Array{Float64,1},
    LDZ1::AbstractFloat, LDZ2::AbstractFloat,
    WR::Array{Float64,1}, WI::Array{Float64,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb03wd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb03wx!(N::Integer, P::Integer, T::Array{Float64,1},
    LDT1::AbstractFloat, LDT2::AbstractFloat,
    WR::Array{Float64,1}, WI::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb03wx_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03xd!(BALANC::Char, JOB::Char, JOBU::Char, JOBV::Char,
    ...
    ccall((:mb03xd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb03xp!(JOB::Char, COMPQ::Char, COMPZ::Char, N::Integer,
    ...
    ccall((:mb03xp_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03xu!(LTRA::Bool, LTRB::Bool, N::Integer, K::Integer,
    ...
    ccall((:mb03xu_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb03ya!(WANTT::Bool, WANTQ::Bool, WANTZ::Bool, N::Integer,
    ...
    ccall((:mb03ya_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{Bool}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb03yd!(WANTT::Bool, WANTQ::Bool, WANTZ::Bool, N::Integer,
    ...
    ccall((:mb03yd_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{Bool}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb03yt!(A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    ALPHAR::Array{Float64,1}, ALPHAI::Array{Float64,1},
    BETA::Array{Float64,1}, CSL::AbstractFloat,
    SNL::AbstractFloat, CSR::AbstractFloat, SNR::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb03yt_, libslicotpath), Void, (Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb03za!(COMPC::Char, COMPU::Char, COMPV::Char, COMPW::Char,
    ...
    ccall((:mb03za_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function mb03zd!(WHICH::Char, METH::Char, STAB::Char, BALANC::Char,
    ...
    ccall((:mb03zd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04ad!(JOB::Char, COMPQ1::Char, COMPQ2::Char, COMPU1::Char,
    ...
    LDZ::AbstractFloat, H::Array{Float64,1}, LDH::AbstractFloat,
    T::Array{Float64,1}, LDT::AbstractFloat,
    Q1::Array{Float64,1}, LDQ1::AbstractFloat,
    Q2::Array{Float64,1}, LDQ2::AbstractFloat,
    U11::Array{Float64,1}, LDU11::AbstractFloat,
    U12::Array{Float64,1}, LDU12::AbstractFloat,
    U21::Array{Float64,1}, LDU21::AbstractFloat,
    U22::Array{Float64,1}, LDU22::AbstractFloat,
    ALPHAR::Array{Float64,1}, ALPHAI::Array{Float64,1},
    ...
    ccall((:mb04ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb04bd!(JOB::Char, COMPQ1::Char, COMPQ2::Char, N::Integer,
    A::Array{Float64,1}, LDA::AbstractFloat,
    DE::Array{Float64,1}, LDDE::AbstractFloat,
    C1::Array{Float64,1}, LDC1::AbstractFloat,
    VW::Array{Float64,1}, LDVW::AbstractFloat,
    Q1::Array{Float64,1}, LDQ1::AbstractFloat,
    Q2::Array{Float64,1}, LDQ2::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    F::Array{Float64,1}, LDF::AbstractFloat,
    C2::Array{Float64,1}, LDC2::AbstractFloat,
    ALPHAR::Array{Float64,1}, ALPHAI::Array{Float64,1},
    BETA::Array{Float64,1}, IWORK::Array{BlasInt,1},
    LIWORK::Integer, DWORK::Array{Float64,1}, LDWORK::Integer)
    ...
    ccall((:mb04bd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb04dd!(JOB::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:mb04dd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04di!(JOB::Char, SGN::Char, N::Integer, ILO::Integer,
    ...
    ccall((:mb04di_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04ds!(JOB::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:mb04ds_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}), &JOB, &N, A,
            &LDA, QG, &LDQG, &ILO, SCALE, INFO)
...
function mb04dy!(JOBSCL::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:mb04dy_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04gd!(M::Integer, N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, JPVT::Array{BlasInt,1},
    TAU::Array{Float64,1}, DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb04gd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb04hd!(COMPQ1::Char, COMPQ2::Char, N::Integer,
    ...
    ccall((:mb04hd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb04id!(N::Integer, M::Integer, P::Integer, L::Integer,
    ...
    ccall((:mb04id_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb04iy!(SIDE::Char, TRANS::Char, N::Integer, M::Integer,
    ...
    LDA::AbstractFloat, TAU::Array{Float64,1},
    C::Array{Float64,1}, LDC::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb04iy_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb04iz!(N::Integer, M::Integer, P::Integer, L::Integer,
    ...
    ccall((:mb04iz_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Complex128},
            Ptr{BlasInt}, Ptr{Complex128}, Ptr{BlasInt},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{BlasInt},
...
function mb04jd!(N::Integer, M::Integer, P::Integer, L::Integer,
    ...
    ccall((:mb04jd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &N, &M, &P, &L, A, &LDA, B,
            &LDB, TAU, DWORK, &LDWORK, INFO)
...
function mb04kd!(UPLO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:mb04kd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}),
...
function mb04ld!(UPLO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:mb04ld_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}),
...
function mb04md!(N::Integer, MAXRED::AbstractFloat,
    A::Array{Float64,1}, LDA::AbstractFloat,
    SCALE::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb04md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb04nd!(UPLO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:mb04nd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}),
            &UPLO, &N, &M, &P, R, &LDR, A, &LDA, B, &LDB, C, &LDC,
...
function mb04ny!(M::Integer, N::Integer, V::Array{Float64,1},
    INCV::Integer, TAU::AbstractFloat, A::Array{Float64,1},
    LDA::AbstractFloat, B::Array{Float64,1}, LDB::AbstractFloat,
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb04ny_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64}),
...
function mb04od!(UPLO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:mb04od_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}),
            &UPLO, &N, &M, &P, R, &LDR, A, &LDA, B, &LDB, C, &LDC,
...
function mb04ow!(M::Integer, N::Integer, P::Integer,
    ...
    ccall((:mb04ow_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb04ox!(N::Integer, A::Array{Float64,2}, LDA::Integer,
    ...
    ccall((:mb04ox_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
...
function mb04oy!(M::Integer, N::Integer, V::Array{Float64,1},
    TAU::AbstractFloat, A::Array{Float64,1}, LDA::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb04oy_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb04pa!(LHAM::Bool, N::Integer, K::Integer, NB::Integer,
    ...
    ccall((:mb04pa_, libslicotpath), Void, (Ptr{Bool}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb04pb!(N::Integer, ILO::Integer, A::Array{Float64,2},
    ...
    ccall((:mb04pb_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04pu!(N::Integer, ILO::Integer, A::Array{Float64,2},
    ...
    ccall((:mb04pu_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}), &N, &ILO, A, &LDA, QG, &LDQG, CS, TAU,
            DWORK, &LDWORK, INFO)
...
function mb04py!(SIDE::Char, M::Integer, N::Integer,
    V::Array{Float64,1}, TAU::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb04py_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb04qb!(TRANC::Char, TRAND::Char, TRANQ::Char, STOREV::Char,
    ...
    ccall((:mb04qb_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb04qc!(STRUCT::Char, TRANA::Char, TRANB::Char, TRANQ::Char,
    ...
    ccall((:mb04qc_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb04qf!(DIRECT::Char, STOREV::Char, STOREW::Char, N::Integer,
    ...
    ccall((:mb04qf_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb04qu!(TRANC::Char, TRAND::Char, TRANQ::Char, STOREV::Char,
    ...
    ccall((:mb04qu_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb04su!(M::Integer, N::Integer, A::Array{Float64,2},
    ...
    ccall((:mb04su_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04tb!(TRANA::Char, TRANB::Char, N::Integer, ILO::Integer,
    ...
    ccall((:mb04tb_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04ts!(TRANA::Char, TRANB::Char, N::Integer, ILO::Integer,
    ...
    ccall((:mb04ts_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04tt!(UPDATQ::Bool, UPDATZ::Bool, M::Integer, N::Integer,
    ...
    RANK::Integer, TOL::AbstractFloat, IWORK::Array{BlasInt,1})

    INFO = BlasInt[0]

    ccall((:mb04tt_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function mb04tu!(N::Integer, X::Array{Float64,1}, INCX::Integer,
    Y::Array{Float64,1}, INCY::Integer, C::AbstractFloat,
    S::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mb04tu_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb04tv!(UPDATZ::Bool, N::Integer, NRA::Integer, NCA::Integer,
    ...
    ccall((:mb04tv_, libslicotpath), Void, (Ptr{Bool}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04tw!(UPDATQ::Bool, M::Integer, N::Integer, NRE::Integer,
    ...
    ccall((:mb04tw_, libslicotpath), Void, (Ptr{Bool}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb04tx!(UPDATQ::Bool, UPDATZ::Bool, M::Integer, N::Integer,
    ...
    ccall((:mb04tx_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function mb04ty!(UPDATQ::Bool, UPDATZ::Bool, M::Integer, N::Integer,
    ...
    ccall((:mb04ty_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &UPDATQ, &UPDATZ, &M, &N,
...
function mb04ud!(JOBQ::Char, JOBZ::Char, M::Integer, N::Integer,
    ...
    ISTAIR::Array{BlasInt,1}, TOL::AbstractFloat,
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb04ud_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function mb04vd!(MODE::Char, JOBQ::Char, JOBZ::Char, M::Integer,
    ...
    MNEI::Array{BlasInt,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1})

    INFO = BlasInt[0]

    ccall((:mb04vd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function mb04vx!(UPDATQ::Bool, UPDATZ::Bool, M::Integer, N::Integer,
    ...
    ccall((:mb04vx_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &UPDATQ, &UPDATZ, &M, &N,
...
function mb04wd!(TRANQ1::Char, TRANQ2::Char, M::Integer, N::Integer,
    ...
    ccall((:mb04wd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mb04wp!(N::Integer, ILO::Integer, U1::Array{Float64,2},
    ...
    ccall((:mb04wp_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04wr!(JOB::Char, TRANS::Char, N::Integer, ILO::Integer,
    ...
    ccall((:mb04wr_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function mb04wu!(TRANQ1::Char, TRANQ2::Char, M::Integer, N::Integer,
    ...
    ccall((:mb04wu_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
            &TRANQ1, &TRANQ2, &M, &N, &K, Q1, &LDQ1, Q2, &LDQ2, CS,
...
function mb04xd!(JOBU::Char, JOBV::Char, M::Integer, N::Integer,
    RANK::Integer, THETA::AbstractFloat, A::Array{Float64,2},
    LDA::Integer, U::Array{Float64,2}, LDU::Integer,
    V::Array{Float64,2}, LDV::Integer,
    Q::Array{Float64,1}, INUL::Array{Bool,1},
    TOL::AbstractFloat, RELTOL::AbstractFloat,
    ...
    ccall((:mb04xd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04xy!(JOBU::Char, JOBV::Char, M::Integer, N::Integer,
    ...
    ccall((:mb04xy_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Bool}, Ptr{BlasInt}),
...
function mb04yd!(JOBU::Char, JOBV::Char, M::Integer, N::Integer,
    RANK::Integer, THETA::AbstractFloat, Q::Array{Float64,1},
    E::Array{Float64,1}, U::Array{Float64,2},
    LDU::Integer, V::Array{Float64,2}, LDV::Integer,
    INUL::Array{Bool,1}, TOL::AbstractFloat, RELTOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:mb04yd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mb04yw!(QRIT::Bool, UPDATU::Bool, UPDATV::Bool, M::Integer,
    N::Integer, L::Integer, K::Integer, SHIFT::AbstractFloat,
    D::Array{Float64,1}, E::Array{Float64,1},
    U::Array{Float64,1}, LDU::AbstractFloat,
    V::Array{Float64,1}, LDV::AbstractFloat,
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mb04yw_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{Bool}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb04zd!(COMPU::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:mb04zd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function mb05md!(BALANC::Char, N::Integer, DELTA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    V::Array{Float64,2}, LDV::Integer,
    ...
    ccall((:mb05md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb05my!(BALANC::Char, N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, WR::Array{Float64,1},
    WI::Array{Float64,1}, R::Array{Float64,1},
    LDR::AbstractFloat, Q::Array{Float64,1}, LDQ::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:mb05my_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mb05nd!(N::Integer, DELTA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    ...
    ccall((:mb05nd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb05od!(BALANC::Char, N::Integer, NDIAG::Integer,
    DELTA::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    MDIG::Integer, IDIG::Integer, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:mb05od_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function mb05oy!(JOB::Char, N::Integer, LOW::Integer, IGH::Integer,
    ...
    ccall((:mb05oy_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mb3oyz!(M::Integer, N::Integer, A::Array{Complex,1},
    LDA::Complex, RCOND::AbstractFloat, SVLMAX::AbstractFloat,
    RANK::Integer, SVAL::Array{Float64,1},
    ...
    ccall((:mb3oyz_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
...
function mb3pyz!(M::Integer, N::Integer, A::Array{Complex,1},
    ...
    ccall((:mb3pyz_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Complex128}, Ptr{Float64}, Ptr{Complex128},
            Ptr{BlasInt}), &M, &N, A, &LDA, &RCOND, &SVLMAX, &RANK,
...
function mc01md!(DP::Integer, ALPHA::AbstractFloat, K::Integer,
    P::Array{Float64,1}, Q::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mc01md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
            &DP, &ALPHA, &K, P, Q, INFO)
...
function mc01nd!(DP::Integer, XR::AbstractFloat, XI::AbstractFloat,
    P::Array{Float64,1}, VR::AbstractFloat, VI::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mc01nd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mc01od!(K::Integer, REZ::Array{Float64,1},
    ...
    ccall((:mc01od_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mc01pd!(K::Integer, REZ::Array{Float64,1},
    ...
    ccall((:mc01pd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function mc01py!(K::Integer, REZ::Array{Float64,1},
    ...
    ccall((:mc01py_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
            &K, REZ, IMZ, P, DWORK, INFO)
...
function mc01qd!(DA::Integer, DB::Integer, A::Array{Float64,1},
    ...
    ccall((:mc01qd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function mc01rd!(DP1::Integer, DP2::Integer, DP3::Integer,
    ALPHA::AbstractFloat, P1::Array{Float64,1},
    P2::Array{Float64,1}, P3::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mc01rd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mc01sd!(DP::Integer, P::Array{Float64,1}, S::Integer,
    ...
    ccall((:mc01sd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function mc01sw!(A::AbstractFloat, B::Integer, M::AbstractFloat,
    E::Integer)

    INFO = BlasInt[0]

    ccall((:mc01sw_, libslicotpath), Void, (Ptr{Float64}, Ptr{BlasInt},
...
function mc01sy!(M::AbstractFloat, E::Integer, B::Integer,
    A::AbstractFloat, OVFLOW::Bool)

    INFO = BlasInt[0]

    ccall((:mc01sy_, libslicotpath), Void, (Ptr{Float64}, Ptr{BlasInt},
...
function mc01td!(DICO::Char, DP::Integer, P::Array{Float64,1},
    ...
    ccall((:mc01td_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
...
function mc01vd!(A::AbstractFloat, B::AbstractFloat, C::AbstractFloat,
    Z1RE::AbstractFloat, Z1IM::AbstractFloat, Z2RE::AbstractFloat,
    Z2IM::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:mc01vd_, libslicotpath), Void, (Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function mc01wd!(DP::Integer, P::Array{Float64,1},
    U1::AbstractFloat, U2::AbstractFloat, Q::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:mc01wd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
            &DP, P, &U1, &U2, Q, INFO)
...
function mc03md!(RP1::Integer, CP1::Integer, CP2::Integer,
    DP1::Integer, DP2::Integer, DP3::Integer, ALPHA::AbstractFloat,
    ...
    ccall((:mc03md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function mc03nd!(MP::Integer, NP::Integer, DP::Integer,
    ...
    ccall((:mc03nd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function mc03nx!(MP::Integer, NP::Integer, DP::Integer,
    ...
    ccall((:mc03nx_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function mc03ny!(NBLCKS::Integer, NRA::Integer, NCA::Integer,
    ...
    ccall((:mc03ny_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function md03ba!(N::Integer, IPAR::Array{BlasInt,1}, LIPAR::Integer,
    FNORM::AbstractFloat, J::Array{Float64,1}, LDJ::Integer,
    E::Array{Float64,1}, JNORMS::Array{Float64,1},
    GNORM::AbstractFloat, IPVT::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:md03ba_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function md03bb!(COND::Char, N::Integer, IPAR::Array{BlasInt,1},
    ...
    QTB::Array{Float64,1}, DELTA::AbstractFloat,
    PAR::AbstractFloat, RANKS::Array{BlasInt,1},
    ...
    ccall((:md03bb_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function md03bf!(IFLAG::Integer, M::Integer, N::Integer,
    ...
    ccall((:md03bf_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function md03bx!(M::Integer, N::Integer, FNORM::AbstractFloat,
    ...
    ccall((:md03bx_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function md03by!(COND::Char, N::Integer, R::Array{Float64,2},
    LDR::Integer, IPVT::Array{BlasInt,1},
    DIAG::Array{Float64,1}, QTB::Array{Float64,1},
    DELTA::AbstractFloat, PAR::AbstractFloat, RANK::Integer,
    X::Array{Float64,1}, RX::Array{Float64,1},
    TOL::AbstractFloat, DWORK::Array{Float64,1},
    LDWORK::Integer)
    ...
    ccall((:md03by_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function nf01ad!(NSMP::Integer, M::Integer, L::Integer,
    ...
    ccall((:nf01ad_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function nf01ay!(NSMP::Integer, NZ::Integer, L::Integer,
    ...
    ccall((:nf01ay_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function nf01ba!(IFLAG::Integer, NSMP::Integer, N::Integer,
    ...
    ccall((:nf01ba_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function nf01bb!(IFLAG::Integer, NFUN::Integer, LX::Integer,
    ...
    ccall((:nf01bb_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function nf01bd!(CJTE::Char, NSMP::Integer, M::Integer, L::Integer,
    ...
    ccall((:nf01bd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function nf01be!(IFLAG::Integer, NSMP::Integer, N::Integer,
    ...
    ccall((:nf01be_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function nf01bf!(IFLAG::Integer, NFUN::Integer, LX::Integer,
    ...
    ccall((:nf01bf_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}), &IFLAG,
...
function nf01bp!(COND::Char, N::Integer, IPAR::Array{BlasInt,1},
    ...
    ccall((:nf01bp_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function nf01bq!(COND::Char, N::Integer, IPAR::Array{BlasInt,1},
    ...
    X::Array{Float64,1}, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:nf01bq_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function nf01br!(COND::Char, UPLO::Char, TRANS::Char, N::Integer,
    ...
    ccall((:nf01br_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function nf01bs!(N::Integer, IPAR::Array{BlasInt,1}, LIPAR::Integer,
    ...
    ccall((:nf01bs_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}), &N, IPAR,
            &LIPAR, &FNORM, J, &LDJ, E, JNORMS, &GNORM, IPVT, DWORK,
...
function nf01bu!(STOR::Char, UPLO::Char, N::Integer,
    ...
    ccall((:nf01bu_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function nf01bv!(STOR::Char, UPLO::Char, N::Integer,
    ...
    ccall((:nf01bv_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
            &STOR, &UPLO, &N, IPAR, &LIPAR, DPAR, &LDPAR, J, &LDJ,
...
function nf01bw!(N::Integer, IPAR::Array{BlasInt,1}, LIPAR::Integer,
    ...
    ccall((:nf01bw_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function nf01bx!(N::Integer, IPAR::Array{BlasInt,1}, LIPAR::Integer,
    ...
    ccall((:nf01bx_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &N, IPAR, &LIPAR, DPAR,
            &LDPAR, J, &LDJ, X, &INCX, DWORK, &LDWORK, INFO)
...
function nf01by!(CJTE::Char, NSMP::Integer, NZ::Integer, L::Integer,
    ...
    ccall((:nf01by_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}), &CJTE, &NSMP,
...
function sb01bd!(DICO::Char, N::Integer, M::Integer, NP::Integer,
    ...
    F::Array{Float64,2}, LDF::Integer,
    Z::Array{Float64,2}, LDZ::Integer, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:sb01bd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb01bx!(REIG::Bool, N::Integer, XR::AbstractFloat,
    XI::AbstractFloat, WR::Array{Float64,1},
    WI::Array{Float64,1}, S::AbstractFloat, P::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:sb01bx_, libslicotpath), Void, (Ptr{Bool}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb01by!(N::Integer, M::Integer, S::AbstractFloat,
    P::AbstractFloat, A::Array{Float64,2},
    B::Array{Float64,2}, F::Array{Float64,2},
    TOL::AbstractFloat, DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:sb01by_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function sb01dd!(N::Integer, M::Integer, INDCON::Integer,
    ...
    LDZ::AbstractFloat, Y::Array{Float64,1}, COUNT::Integer,
    G::Array{Float64,1}, LDG::AbstractFloat, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb01dd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function sb01fy!(DISCR::Bool, N::Integer, M::Integer,
    ...
    ccall((:sb01fy_, libslicotpath), Void, (Ptr{Bool}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb01md!(NCONT::Integer, N::Integer,
    ...
    ccall((:sb01md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb02md!(DICO::Char, HINV::Char, UPLO::Char, SCAL::Char,
    ...
    G::Array{Float64,2}, LDG::Integer,
    Q::Array{Float64,2}, LDQ::Integer, RCOND::AbstractFloat,
    WR::Array{Float64,1}, WI::Array{Float64,1},
    S::Array{Float64,2}, LDS::Integer,
    ...
    ccall((:sb02md_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb02mt!(JOBG::Char, JOBL::Char, FACT::Char, UPLO::Char,
    ...
    ccall((:sb02mt_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function sb02mu!(DICO::Char, HINV::Char, UPLO::Char, N::Integer,
    ...
    ccall((:sb02mu_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
...
function sb02nd!(DICO::Char, FACT::Char, UPLO::Char, JOBL::Char,
    ...
    L::Array{Float64,2}, LDL::Integer,
    X::Array{Float64,2}, LDX::Integer, RNORM::AbstractFloat,
    ...
    ccall((:sb02nd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb02od!(DICO::Char, JOBB::Char, FACT::Char, UPLO::Char,
    ...
    Q::Array{Float64,2}, LDQ::Integer,
    R::Array{Float64,2}, LDR::Integer,
    L::Array{Float64,2}, LDL::Integer, RCOND::AbstractFloat,
    X::Array{Float64,2}, LDX::Integer,
    ...
    U::Array{Float64,2}, LDU::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, BWORK::Array{Bool,1})

    INFO = BlasInt[0]

    ccall((:sb02od_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb02oy!(TYPE::Char, DICO::Char, JOBB::Char, FACT::Char,
    ...
    BF::Array{Float64,2}, LDBF::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb02oy_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb02pd!(JOB::Char, TRANA::Char, UPLO::Char, N::Integer,
    A::Array{Float64,1}, LDA::AbstractFloat,
    G::Array{Float64,1}, LDG::AbstractFloat,
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    X::Array{Float64,1}, LDX::AbstractFloat,
    RCOND::AbstractFloat, FERR::AbstractFloat,
    WR::Array{Float64,1}, WI::Array{Float64,1},
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)
    ...
    ccall((:sb02pd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb02qd!(JOB::Char, FACT::Char, TRANA::Char, UPLO::Char,
    ...
    LDA::AbstractFloat, T::Array{Float64,1}, LDT::AbstractFloat,
    U::Array{Float64,1}, LDU::AbstractFloat,
    G::Array{Float64,1}, LDG::AbstractFloat,
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    X::Array{Float64,1}, LDX::AbstractFloat, SEP::AbstractFloat,
    RCOND::AbstractFloat, FERR::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)
    ...
    ccall((:sb02qd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb02rd!(JOB::Char, DICO::Char, HINV::Char, TRANA::Char,
    ...
    G::Array{Float64,2}, LDG::Integer,
    Q::Array{Float64,2}, LDQ::Integer,
    X::Array{Float64,2}, LDX::Integer, SEP::AbstractFloat,
    RCOND::AbstractFloat, FERR::AbstractFloat,
    WR::Array{Float64,1}, WI::Array{Float64,1},
    S::Array{Float64,2}, LDS::Integer, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer,
    ...
    ccall((:sb02rd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb02ru!(DICO::Char, HINV::Char, TRANA::Char, UPLO::Char,
    ...
    ccall((:sb02ru_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function sb02sd!(JOB::Char, FACT::Char, TRANA::Char, UPLO::Char,
    ...
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    X::Array{Float64,1}, LDX::AbstractFloat,
    SEPD::AbstractFloat, RCOND::AbstractFloat, FERR::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb02sd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03md!(DICO::Char, JOB::Char, FACT::Char, TRANA::Char,
    N::Integer, A::Array{Float64,1}, LDA::AbstractFloat,
    U::Array{Float64,1}, LDU::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    SCALE::AbstractFloat, SEP::AbstractFloat, FERR::AbstractFloat,
    WR::Array{Float64,1}, WI::Array{Float64,1},
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)
    ...
    ccall((:sb03md_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb03mu!(LTRANL::Bool, LTRANR::Bool, ISGN::Integer,
    ...
    LDTL::AbstractFloat, TR::Array{Float64,1},
    LDTR::AbstractFloat, B::Array{Float64,1},
    LDB::AbstractFloat, SCALE::AbstractFloat,
    X::Array{Float64,1}, LDX::AbstractFloat,
    XNORM::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:sb03mu_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03mv!(LTRAN::Bool, LUPPER::Bool, T::Array{Float64,1},
    LDT::AbstractFloat, B::Array{Float64,1}, LDB::AbstractFloat,
    SCALE::AbstractFloat, X::Array{Float64,1},
    LDX::AbstractFloat, XNORM::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:sb03mv_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03mw!(LTRAN::Bool, LUPPER::Bool, T::Array{Float64,1},
    ...
    ccall((:sb03mw_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}), &LTRAN, &LUPPER, T, &LDT, B, &LDB,
            &SCALE, X, &LDX, &XNORM, INFO)
...
function sb03mx!(TRANA::Char, N::Integer, A::Array{Float64,1},
    LDA::AbstractFloat, C::Array{Float64,1}, LDC::AbstractFloat,
    SCALE::AbstractFloat, DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:sb03mx_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03my!(TRANA::Char, N::Integer, A::Array{Float64,1},
    ...
    ccall((:sb03my_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03od!(DICO::Char, FACT::Char, TRANS::Char, N::Integer,
    M::Integer, A::Array{Float64,2}, LDA::Integer,
    Q::Array{Float64,2}, LDQ::Integer,
    B::Array{Float64,2}, LDB::Integer, SCALE::AbstractFloat,
    WR::Array{Float64,1}, WI::Array{Float64,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb03od_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03or!(DISCR::Bool, LTRANS::Bool, N::Integer, M::Integer,
    S::Array{Float64,1}, LDS::AbstractFloat,
    A::Array{Float64,1}, LDA::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    SCALE::AbstractFloat)
    ...
    ccall((:sb03or_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03ot!(DISCR::Bool, LTRANS::Bool, N::Integer,
    S::Array{Float64,2}, LDS::Integer,
    R::Array{Float64,2}, LDR::Integer, SCALE::AbstractFloat,
    DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:sb03ot_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function sb03ou!(DISCR::Bool, LTRANS::Bool, N::Integer, M::Integer,
    ...
    LDU::Integer, SCALE::AbstractFloat, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb03ou_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function sb03ov!(A::Array{Float64,1}, B::AbstractFloat,
    C::Array{Float64,1}, S::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:sb03ov_, libslicotpath), Void, (Ptr{Float64}, Ptr{Float64},
...
function sb03oy!(DISCR::Bool, LTRANS::Bool, ISGN::Integer,
    S::Array{Float64,2}, LDS::Integer,
    R::Array{Float64,2}, LDR::Integer,
    A::Array{Float64,2}, LDA::Integer, SCALE::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:sb03oy_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb03pd!(JOB::Char, FACT::Char, TRANA::Char, N::Integer,
    ...
    U::Array{Float64,1}, LDU::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    SCALE::AbstractFloat, SEPD::AbstractFloat, FERR::AbstractFloat,
    WR::Array{Float64,1}, WI::Array{Float64,1},
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)
    ...
    ccall((:sb03pd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb03qd!(JOB::Char, FACT::Char, TRANA::Char, UPLO::Char,
    LYAPUN::Char, N::Integer, SCALE::AbstractFloat,
    A::Array{Float64,1}, LDA::AbstractFloat,
    T::Array{Float64,1}, LDT::AbstractFloat,
    U::Array{Float64,1}, LDU::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    ...
    ccall((:sb03qd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03qx!(TRANA::Char, UPLO::Char, LYAPUN::Char, N::Integer,
    XANORM::AbstractFloat, T::Array{Float64,1},
    LDT::AbstractFloat, U::Array{Float64,1}, LDU::AbstractFloat,
    R::Array{Float64,1}, LDR::AbstractFloat,
    FERR::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb03qx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb03qy!(JOB::Char, TRANA::Char, LYAPUN::Char, N::Integer,
    ...
    U::Array{Float64,1}, LDU::AbstractFloat,
    X::Array{Float64,1}, LDX::AbstractFloat, SEP::AbstractFloat,
    THNORM::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb03qy_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb03rd!(JOB::Char, FACT::Char, TRANA::Char, N::Integer,
    ...
    ccall((:sb03rd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb03sd!(JOB::Char, FACT::Char, TRANA::Char, UPLO::Char,
    ...
    ccall((:sb03sd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03sx!(TRANA::Char, UPLO::Char, LYAPUN::Char, N::Integer,
    ...
    ccall((:sb03sx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &TRANA, &UPLO, &LYAPUN, &N,
...
function sb03sy!(JOB::Char, TRANA::Char, LYAPUN::Char, N::Integer,
    T::Array{Float64,1}, LDT::AbstractFloat,
    U::Array{Float64,1}, LDU::AbstractFloat,
    XA::Array{Float64,1}, LDXA::AbstractFloat,
    SEPD::AbstractFloat, THNORM::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb03sy_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &JOB, &TRANA, &LYAPUN, &N,
...
function sb03td!(JOB::Char, FACT::Char, TRANA::Char, UPLO::Char,
    ...
    ccall((:sb03td_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb03ud!(JOB::Char, FACT::Char, TRANA::Char, UPLO::Char,
    ...
    ccall((:sb03ud_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb04md!(N::Integer, M::Integer, A::Array{Float64,2},
    ...
    ccall((:sb04md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function sb04mr!(M::Integer, D::Array{Float64,1},
    ...
    ccall((:sb04mr_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
...
function sb04mu!(N::Integer, M::Integer, IND::Integer,
    ...
    ccall((:sb04mu_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb04mw!(M::Integer, D::Array{Float64,1},
    ...
    ccall((:sb04mw_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &M, D, IPR, INFO)
...
function sb04my!(N::Integer, M::Integer, IND::Integer,
    ...
    ccall((:sb04my_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &N, &M, &IND, A, &LDA, B,
            &LDB, C, &LDC, D, IPR, INFO)
...
function sb04nd!(ABSCHU::Char, ULA::Char, ULB::Char, N::Integer,
    M::Integer, A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb04nd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb04nv!(ABSCHR::Char, UL::Char, N::Integer, M::Integer,
    ...
    ccall((:sb04nv_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}),
...
function sb04nw!(ABSCHR::Char, UL::Char, N::Integer, M::Integer,
    ...
    ccall((:sb04nw_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}),
            &ABSCHR, &UL, &N, &M, C, &LDC, &INDX, AB, &LDAB, D)
...
function sb04nx!(RC::Char, UL::Char, M::Integer,
    A::Array{Float64,2}, LDA::Integer, LAMBD1::AbstractFloat,
    LAMBD2::AbstractFloat, LAMBD3::AbstractFloat,
    LAMBD4::AbstractFloat, D::Array{Float64,1},
    TOL::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,2}, LDDWOR::Integer)

    INFO = BlasInt[0]

    ccall((:sb04nx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb04ny!(RC::Char, UL::Char, M::Integer,
    A::Array{Float64,2}, LDA::Integer, LAMBDA::AbstractFloat,
    D::Array{Float64,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,2},
    LDDWOR::Integer)

    INFO = BlasInt[0]

    ccall((:sb04ny_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb04od!(REDUCE::Char, TRANS::Char, JOBD::Char, M::Integer,
    ...
    D::Array{Float64,2}, LDD::Integer,
    E::Array{Float64,2}, LDE::Integer,
    F::Array{Float64,2}, LDF::Integer, SCALE::AbstractFloat,
    DIF::AbstractFloat, P::Array{Float64,2}, LDP::Integer,
    Q::Array{Float64,2}, LDQ::Integer,
    U::Array{Float64,2}, LDU::Integer,
    ...
    ccall((:sb04od_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb04ow!(M::Integer, N::Integer, A::Array{Float64,2},
    ...
    ccall((:sb04ow_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb04pd!(DICO::Char, FACTA::Char, FACTB::Char, TRANA::Char,
    ...
    ccall((:sb04pd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb04px!(LTRANL::Bool, LTRANR::Bool, ISGN::Integer,
    ...
    ccall((:sb04px_, libslicotpath), Void, (Ptr{Bool}, Ptr{Bool},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}), &LTRANL, &LTRANR, &ISGN,
...
function sb04py!(TRANA::Char, TRANB::Char, ISGN::Integer, M::Integer,
    ...
    ccall((:sb04py_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function sb04qd!(N::Integer, M::Integer, A::Array{Float64,2},
    ...
    ccall((:sb04qd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
            &N, &M, A, &LDA, B, &LDB, C, &LDC, Z, &LDZ, IWORK,
...
function sb04qr!(M::Integer, D::Array{Float64,1},
    ...
    ccall((:sb04qr_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &M, D, IPR, INFO)
...
function sb04qu!(N::Integer, M::Integer, IND::Integer,
    ...
    ccall((:sb04qu_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &N, &M, &IND, A, &LDA, B,
            &LDB, C, &LDC, D, IPR, INFO)
...
function sb04qy!(N::Integer, M::Integer, IND::Integer,
    ...
    ccall((:sb04qy_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &N, &M, &IND, A, &LDA, B,
            &LDB, C, &LDC, D, IPR, INFO)
...
function sb04rd!(ABSCHU::Char, ULA::Char, ULB::Char, N::Integer,
    ...
    ccall((:sb04rd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &ABSCHU, &ULA, &ULB, &N,
...
function sb04rv!(ABSCHR::Char, UL::Char, N::Integer, M::Integer,
    ...
    ccall((:sb04rv_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb04rw!(ABSCHR::Char, UL::Char, N::Integer, M::Integer,
    ...
    ccall((:sb04rw_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}), &ABSCHR, &UL,
            &N, &M, C, &LDC, &INDX, AB, &LDAB, BA, &LDBA, D, DWORK)
...
function sb04rx!(RC::Char, UL::Char, M::Integer,
    ...
    ccall((:sb04rx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}), &RC, &UL, &M, A, &LDA, &LAMBD1, &LAMBD2,
...
function sb04ry!(RC::Char, UL::Char, M::Integer,
    ...
    ccall((:sb04ry_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &RC, &UL, &M, A, &LDA,
            &LAMBDA, D, &TOL, IWORK, DWORK, &LDDWOR, INFO)
...
function sb06nd!(N::Integer, M::Integer, KMAX::Integer,
    ...
    ccall((:sb06nd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function sb08cd!(DICO::Char, N::Integer, M::Integer, P::Integer,
    ...
    DR::Array{Float64,2}, LDDR::Integer, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:sb08cd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb08dd!(DICO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:sb08dd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb08ed!(DICO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:sb08ed_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb08fd!(DICO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:sb08fd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb08gd!(N::Integer, M::Integer, P::Integer,
    ...
    ccall((:sb08gd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function sb08hd!(N::Integer, M::Integer, P::Integer,
    ...
    ccall((:sb08hd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function sb08md!(ACONA::Char, DA::Integer, A::Array{Float64,1},
    RES::AbstractFloat, E::Array{Float64,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb08md_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb08my!(DA::Integer, A::Array{Float64,1},
    B::Array{Float64,1}, EPSB::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:sb08my_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
...
function sb08nd!(ACONA::Char, DA::Integer, A::Array{Float64,1},
    ...
    ccall((:sb08nd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}), &ACONA, &DA, A, &RES, E,
            DWORK, &LDWORK, INFO)
...
function sb08ny!(DA::Integer, A::Array{Float64,1},
    ...
    ccall((:sb08ny_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}), &DA, A, B, &EPSB)
...
function sb09md!(N::Integer, NC::Integer, NB::Integer,
    ...
    PRE::Array{Float64,2}, LDPRE::Integer, TOL::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:sb09md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb10ad!(JOB::Integer, N::Integer, M::Integer, NP::Integer,
    NCON::Integer, NMEAS::Integer, GAMMA::AbstractFloat,
    A::Array{Float64,1}, LDA::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    AK::Array{Float64,1}, LDAK::AbstractFloat,
    BK::Array{Float64,1}, LDBK::AbstractFloat,
    CK::Array{Float64,1}, LDCK::AbstractFloat,
    DK::Array{Float64,1}, LDDK::AbstractFloat,
    AC::Array{Float64,1}, LDAC::AbstractFloat,
    BC::Array{Float64,1}, LDBC::AbstractFloat,
    CC::Array{Float64,1}, LDCC::AbstractFloat,
    DC::Array{Float64,1}, LDDC::AbstractFloat,
    RCOND::Array{Float64,1}, GTOL::AbstractFloat,
    ACTOL::AbstractFloat, IWORK::Array{BlasInt,1}, LIWORK::Integer,
    DWORK::Array{Float64,1}, LDWORK::Integer,
    BWORK::Array{Bool,1}, LBWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb10ad_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10dd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    NMEAS::Integer, GAMMA::AbstractFloat, A::Array{Float64,1},
    LDA::AbstractFloat, B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    AK::Array{Float64,1}, LDAK::AbstractFloat,
    ...
    DK::Array{Float64,1}, LDDK::AbstractFloat,
    X::Array{Float64,1}, LDX::AbstractFloat,
    Z::Array{Float64,1}, LDZ::AbstractFloat,
    RCOND::Array{Float64,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, BWORK::Array{Bool,1})

    INFO = BlasInt[0]

    ccall((:sb10dd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10ed!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    NMEAS::Integer, A::Array{Float64,1}, LDA::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    AK::Array{Float64,1}, LDAK::AbstractFloat,
    ...
    ccall((:sb10ed_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10fd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    ccall((:sb10fd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10hd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    ccall((:sb10hd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10id!(N::Integer, M::Integer, NP::Integer,
    ...
    C::Array{Float64,1}, LDC::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    FACTOR::AbstractFloat, NK::Integer, AK::Array{Float64,1},
    LDAK::AbstractFloat, BK::Array{Float64,1},
    LDBK::AbstractFloat, CK::Array{Float64,1},
    LDCK::AbstractFloat, DK::Array{Float64,1},
    LDDK::AbstractFloat, RCOND::Array{Float64,1},
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer, BWORK::Array{Bool,1})

    INFO = BlasInt[0]

    ccall((:sb10id_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10jd!(N::Integer, M::Integer, NP::Integer,
    ...
    C::Array{Float64,1}, LDC::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    E::Array{Float64,1}, LDE::AbstractFloat, NSYS::Integer,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb10jd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function sb10kd!(N::Integer, M::Integer, NP::Integer,
    ...
    B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    FACTOR::AbstractFloat, AK::Array{Float64,1},
    LDAK::AbstractFloat, BK::Array{Float64,1},
    LDBK::AbstractFloat, CK::Array{Float64,1},
    LDCK::AbstractFloat, DK::Array{Float64,1},
    LDDK::AbstractFloat, RCOND::Array{Float64,1},
    ...
    ccall((:sb10kd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10ld!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    ccall((:sb10ld_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10md!(NC::Integer, MP::Integer, LENDAT::Integer,
    ...
    ITYPE::Array{BlasInt,1}, QUTOL::AbstractFloat,
    A::Array{Float64,1}, LDA::Integer,
    B::Array{Float64,1}, LDB::Integer,
    C::Array{Float64,1}, LDC::Integer,
    D::Array{Float64,1}, LDD::Integer,
    ...
    ccall((:sb10md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb10pd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    C::Array{Float64,1}, LDC::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    TU::Array{Float64,1}, LDTU::AbstractFloat,
    TY::Array{Float64,1}, LDTY::AbstractFloat,
    RCOND::Array{Float64,1}, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb10pd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10qd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    H::Array{Float64,1}, LDH::AbstractFloat,
    X::Array{Float64,1}, LDX::AbstractFloat,
    Y::Array{Float64,1}, LDY::AbstractFloat,
    ...
    ccall((:sb10qd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10rd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    ccall((:sb10rd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10sd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    ccall((:sb10sd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10td!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    NMEAS::Integer, D::Array{Float64,1}, LDD::AbstractFloat,
    TU::Array{Float64,1}, LDTU::AbstractFloat,
    TY::Array{Float64,1}, LDTY::AbstractFloat,
    AK::Array{Float64,1}, LDAK::AbstractFloat,
    BK::Array{Float64,1}, LDBK::AbstractFloat,
    CK::Array{Float64,1}, LDCK::AbstractFloat,
    DK::Array{Float64,1}, LDDK::AbstractFloat,
    RCOND::AbstractFloat, TOL::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:sb10td_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10ud!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    NMEAS::Integer, B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    D::Array{Float64,1}, LDD::AbstractFloat,
    TU::Array{Float64,1}, LDTU::AbstractFloat,
    TY::Array{Float64,1}, LDTY::AbstractFloat,
    ...
    ccall((:sb10ud_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10vd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    ccall((:sb10vd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10wd!(N::Integer, M::Integer, NP::Integer, NCON::Integer,
    ...
    ccall((:sb10wd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10yd!(DISCFL::Integer, FLAG::Integer, LENDAT::Integer,
    ...
    ccall((:sb10yd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Complex128},
...
function sb10zd!(N::Integer, M::Integer, NP::Integer,
    A::AbstractFloat, LDA::AbstractFloat, B::AbstractFloat,
    LDB::AbstractFloat, C::AbstractFloat, LDC::AbstractFloat,
    D::AbstractFloat, LDD::AbstractFloat, FACTOR::AbstractFloat,
    AK::Array{Float64,1}, LDAK::AbstractFloat,
    BK::Array{Float64,1}, LDBK::AbstractFloat,
    CK::Array{Float64,1}, LDCK::AbstractFloat,
    DK::Array{Float64,1}, LDDK::AbstractFloat,
    ...
    ccall((:sb10zd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sb10zp!(DISCFL::Integer, N::Integer,
    ...
    ccall((:sb10zp_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb16ad!(DICO::Char, JOBC::Char, JOBO::Char, JOBMR::Char,
    WEIGHT::Char, EQUIL::Char, ORDSEL::Char, N::Integer, M::Integer,
    P::Integer, NC::Integer, NCR::Integer, ALPHA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer,
    ...
    HSVC::Array{Float64,1}, TOL1::AbstractFloat,
    TOL2::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer, IWARN::Integer)

    INFO = BlasInt[0]

    ccall((:sb16ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb16ay!(DICO::Char, JOBC::Char, JOBO::Char, WEIGHT::Char,
    ...
    BC::Array{Float64,2}, LDBC::Integer,
    CC::Array{Float64,2}, LDCC::Integer,
    DC::Array{Float64,2}, LDDC::Integer, SCALEC::AbstractFloat,
    SCALEO::AbstractFloat, S::Array{Float64,2}, LDS::Integer,
    R::Array{Float64,2}, LDR::Integer, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)
    ...
    ccall((:sb16ay_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb16bd!(DICO::Char, JOBD::Char, JOBMR::Char, JOBCF::Char,
    ...
    ccall((:sb16bd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sb16cd!(DICO::Char, JOBD::Char, JOBMR::Char, JOBCF::Char,
    ...
    ccall((:sb16cd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sb16cy!(DICO::Char, JOBCF::Char, N::Integer, M::Integer,
    ...
    C::Array{Float64,2}, LDC::Integer,
    F::Array{Float64,2}, LDF::Integer,
    G::Array{Float64,2}, LDG::Integer, SCALEC::AbstractFloat,
    SCALEO::AbstractFloat, S::Array{Float64,2}, LDS::Integer,
    R::Array{Float64,2}, LDR::Integer,
    DWORK::Array{Float64,1}, LDWORK::Integer)
    ...
    ccall((:sb16cy_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sg02ad!(DICO::Char, JOBB::Char, FACT::Char, UPLO::Char,
    ...
    Q::Array{Float64,2}, LDQ::Integer,
    R::Array{Float64,2}, LDR::Integer,
    L::Array{Float64,2}, LDL::Integer, RCONDU::AbstractFloat,
    X::Array{Float64,2}, LDX::Integer,
    ALFAR::Array{Float64,1}, ALFAI::Array{Float64,1},
    BETA::Array{Float64,1}, S::Array{Float64,2},
    LDS::Integer, T::Array{Float64,2}, LDT::Integer,
    ...
    ccall((:sg02ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function sg03ad!(DICO::Char, JOB::Char, FACT::Char, TRANS::Char,
    ...
    Q::Array{Float64,2}, LDQ::Integer,
    Z::Array{Float64,2}, LDZ::Integer,
    X::Array{Float64,2}, LDX::Integer, SCALE::AbstractFloat,
    SEP::AbstractFloat, FERR::AbstractFloat,
    ALPHAR::Array{Float64,1}, ALPHAI::Array{Float64,1},
    BETA::Array{Float64,1}, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)
    ...
    ccall((:sg03ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function sg03ax!(TRANS::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:sg03ax_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function sg03ay!(TRANS::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:sg03ay_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
            &TRANS, &N, A, &LDA, E, &LDE, X, &LDX, &SCALE, INFO)
...
function sg03bd!(DICO::Char, FACT::Char, TRANS::Char, N::Integer,
    ...
    ccall((:sg03bd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function sg03bu!(TRANS::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:sg03bu_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function sg03bv!(TRANS::Char, N::Integer, A::Array{Float64,2},
    ...
    ccall((:sg03bv_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}), &TRANS, &N, A, &LDA, E, &LDE, B, &LDB,
            &SCALE, DWORK, INFO)
...
function sg03bw!(TRANS::Char, M::Integer, N::Integer,
    ...
    ccall((:sg03bw_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sg03bx!(DICO::Char, TRANS::Char, A::Array{Float64,2},
    LDA::Integer, E::Array{Float64,2}, LDE::Integer,
    B::Array{Float64,2}, LDB::Integer,
    U::Array{Float64,2}, LDU::Integer, SCALE::AbstractFloat,
    M1::Array{Float64,2}, LDM1::Integer,
    M2::Array{Float64,2}, LDM2::Integer)

    INFO = BlasInt[0]

    ccall((:sg03bx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function sg03by!(XR::AbstractFloat, XI::AbstractFloat,
    YR::AbstractFloat, YI::AbstractFloat, CR::AbstractFloat,
    CI::AbstractFloat, SR::AbstractFloat, SI::AbstractFloat,
    Z::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:sg03by_, libslicotpath), Void, (Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tb01id!(JOB::Char, N::Integer, M::Integer, P::Integer,
    MAXRED::AbstractFloat, A::Array{Float64,1},
    LDA::AbstractFloat, B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    SCALE::Array{Float64,1})
    ...
    ccall((:tb01id_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tb01iz!(JOB::Char, N::Integer, M::Integer, P::Integer,
    MAXRED::AbstractFloat, A::Array{Complex,1}, LDA::Complex,
    B::Array{Complex,1}, LDB::Complex, C::Array{Complex,1},
    LDC::Complex, SCALE::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:tb01iz_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Complex128},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Complex128},
...
function tb01kd!(DICO::Char, STDOM::Char, JOBA::Char, N::Integer,
    M::Integer, P::Integer, ALPHA::AbstractFloat,
    A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    ...
    ccall((:tb01kd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function tb01ld!(DICO::Char, STDOM::Char, JOBA::Char, N::Integer,
    ...
    ccall((:tb01ld_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function tb01md!(JOBU::Char, UPLO::Char, N::Integer, M::Integer,
    ...
    ccall((:tb01md_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tb01nd!(JOBU::Char, UPLO::Char, N::Integer, P::Integer,
    ...
    ccall((:tb01nd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tb01pd!(JOB::Char, EQUIL::Char, N::Integer, M::Integer,
    ...
    ccall((:tb01pd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tb01td!(N::Integer, M::Integer, P::Integer,
    ...
    ccall((:tb01td_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function tb01ty!(MODE::Integer, IOFF::Integer, JOFF::Integer,
    NROW::Integer, NCOL::Integer, SIZE::AbstractFloat,
    X::Array{Float64,2}, LDX::Integer,
    BVECT::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:tb01ty_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
...
function tb01ud!(JOBZ::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:tb01ud_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function tb01vd!(APPLY::Char, N::Integer, M::Integer, L::Integer,
    ...
    ccall((:tb01vd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function tb01vy!(APPLY::Char, N::Integer, M::Integer, L::Integer,
    ...
    ccall((:tb01vy_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function tb01wd!(N::Integer, M::Integer, P::Integer,
    ...
    ccall((:tb01wd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tb01xd!(JOBD::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:tb01xd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tb01xz!(JOBD::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:tb01xz_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Complex128},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Complex128},
...
function tb01yd!(N::Integer, M::Integer, P::Integer,
    ...
    ccall((:tb01yd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function tb01zd!(JOBZ::Char, N::Integer, P::Integer,
    ...
    LDZ::Integer, TAU::Array{Float64,1}, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:tb01zd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tb03ad!(LERI::Char, EQUIL::Char, N::Integer, M::Integer,
    ...
    LDVCO1::Integer, LDVCO2::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:tb03ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function tb03ay!(NR::Integer, A::Array{Float64,2}, LDA::Integer,
    ...
    ccall((:tb03ay_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tb04ad!(ROWCOL::Char, N::Integer, M::Integer, P::Integer,
    ...
    LDUCO2::Integer, TOL1::AbstractFloat, TOL2::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:tb04ad_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tb04ay!(N::Integer, MWORK::Integer, PWORK::Integer,
    ...
    TAU::Array{Float64,1}, TOL1::AbstractFloat,
    TOL2::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:tb04ay_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function tb04bd!(JOBD::Char, ORDER::Char, EQUIL::Char, N::Integer,
    ...
    ccall((:tb04bd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function tb04bv!(ORDER::Char, P::Integer, M::Integer, MD::Integer,
    ...
    LDD::Integer, TOL::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:tb04bv_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}),
...
function tb04bw!(ORDER::Char, P::Integer, M::Integer, MD::Integer,
    ...
    ccall((:tb04bw_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function tb04bx!(IP::Integer, IZ::Integer, A::Array{Float64,2},
    ...
    C::Array{Float64,1}, D::AbstractFloat,
    PR::Array{Float64,1}, PI::Array{Float64,1},
    ZR::Array{Float64,1}, ZI::Array{Float64,1},
    GAIN::AbstractFloat, IWORK::Array{BlasInt,1})

    INFO = BlasInt[0]

    ccall((:tb04bx_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tb04cd!(JOBD::Char, EQUIL::Char, N::Integer, M::Integer,
    ...
    ccall((:tb04cd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function tb05ad!(BALEIG::Char, INITA::Char, N::Integer, M::Integer,
    ...
    LDA::Integer, B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer, RCOND::AbstractFloat,
    ...
    ccall((:tb05ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
...
function tc01od!(LERI::Char, M::Integer, P::Integer, INDLIM::Integer,
    ...
    ccall((:tc01od_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
...
function tc04ad!(LERI::Char, M::Integer, P::Integer,
    ...
    RCOND::AbstractFloat, A::Array{Float64,2}, LDA::Integer,
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)
    ...
    ccall((:tc04ad_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tc05ad!(LERI::Char, M::Integer, P::Integer, SVAL::Complex,
    INDEX::Array{BlasInt,1}, PCOEFF::Array{Float64,3},
    LDPCO1::Integer, LDPCO2::Integer, QCOEFF::Array{Float64,3},
    LDQCO1::Integer, LDQCO2::Integer, RCOND::AbstractFloat,
    ...
    ccall((:tc05ad_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Complex128}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Complex128}, Ptr{BlasInt}, Ptr{BlasInt},
...
function td03ad!(ROWCOL::Char, LERI::Char, EQUIL::Char, M::Integer,
    ...
    ccall((:td03ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function td03ay!(MWORK::Integer, PWORK::Integer,
    ...
    ccall((:td03ay_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function td04ad!(ROWCOL::Char, M::Integer, P::Integer,
    ...
    LDA::Integer, B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer,
    D::Array{Float64,2}, LDD::Integer, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:td04ad_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function td05ad!(UNITF::Char, OUTPUT::Char, NP1::Integer,
    MP1::Integer, W::AbstractFloat, A::Array{Float64,1},
    B::Array{Float64,1}, VALR::AbstractFloat,
    VALI::AbstractFloat)

    INFO = BlasInt[0]

    ccall((:td05ad_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function tf01md!(N::Integer, M::Integer, P::Integer, NY::Integer,
    ...
    ccall((:tf01md_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function tf01mx!(N::Integer, M::Integer, P::Integer, NY::Integer,
    ...
    ccall((:tf01mx_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}),
...
function tf01my!(N::Integer, M::Integer, P::Integer, NY::Integer,
    ...
    ccall((:tf01my_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
...
function tf01nd!(UPLO::Char, N::Integer, M::Integer, P::Integer,
    ...
    ccall((:tf01nd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function tf01od!(NH1::Integer, NH2::Integer, NR::Integer, NC::Integer,
    ...
    ccall((:tf01od_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tf01pd!(NH1::Integer, NH2::Integer, NR::Integer, NC::Integer,
    ...
    ccall((:tf01pd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{BlasInt}), &NH1, &NH2,
            &NR, &NC, H, &LDH, T, &LDT, INFO)
...
function tf01qd!(NC::Integer, NB::Integer, N::Integer,
    ...
    ccall((:tf01qd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
...
function tf01rd!(NA::Integer, NB::Integer, NC::Integer, N::Integer,
    ...
    ccall((:tf01rd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tg01ad!(JOB::Char, L::Integer, N::Integer, M::Integer,
    P::Integer, THRESH::AbstractFloat, A::Array{Float64,1},
    LDA::AbstractFloat, E::Array{Float64,1}, LDE::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    ...
    ccall((:tg01ad_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt}),
...
function tg01az!(JOB::Char, L::Integer, N::Integer, M::Integer,
    P::Integer, THRESH::AbstractFloat, A::Array{Complex,1},
    ...
    ccall((:tg01az_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Complex128},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Complex128},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Float64},
...
function tg01bd!(JOBE::Char, COMPQ::Char, COMPZ::Char, N::Integer,
    ...
    ccall((:tg01bd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tg01cd!(COMPQ::Char, L::Integer, N::Integer, M::Integer,
    ...
    ccall((:tg01cd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function tg01dd!(COMPZ::Char, L::Integer, N::Integer, P::Integer,
    ...
    ccall((:tg01dd_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function tg01ed!(JOBA::Char, L::Integer, N::Integer, M::Integer,
    P::Integer, A::Array{Float64,1}, LDA::AbstractFloat,
    E::Array{Float64,1}, LDE::AbstractFloat,
    B::Array{Float64,1}, LDB::AbstractFloat,
    C::Array{Float64,1}, LDC::AbstractFloat,
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    Z::Array{Float64,1}, LDZ::AbstractFloat, RANKE::Integer,
    RNKA22::Integer, TOL::AbstractFloat,
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:tg01ed_, libslicotpath), Void, (Ptr{Char}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{BlasInt},
...
function tg01fd!(COMPQ::Char, COMPZ::Char, JOBA::Char, L::Integer,
    ...
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    Z::Array{Float64,1}, LDZ::AbstractFloat, RANKE::Integer,
    RNKA22::Integer, TOL::AbstractFloat, IWORK::Array{BlasInt,1},
    DWORK::Array{Float64,1}, LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:tg01fd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tg01fz!(COMPQ::Char, COMPZ::Char, JOBA::Char, L::Integer,
    ...
    ccall((:tg01fz_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Complex128}, Ptr{Complex128},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Complex128},
            Ptr{Complex128}, Ptr{Complex128}, Ptr{Complex128},
...
function tg01hd!(JOBCON::Char, COMPQ::Char, COMPZ::Char, N::Integer,
    ...
    C::Array{Float64,1}, LDC::AbstractFloat,
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    Z::Array{Float64,1}, LDZ::AbstractFloat, NCONT::Integer,
    ...
    ccall((:tg01hd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tg01hx!(COMPQ::Char, COMPZ::Char, L::Integer, N::Integer,
    ...
    C::Array{Float64,1}, LDC::AbstractFloat,
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    Z::Array{Float64,1}, LDZ::AbstractFloat, NR::Integer,
    NRBLCK::Integer, RTAU::Array{BlasInt,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1})

    INFO = BlasInt[0]

    ccall((:tg01hx_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tg01id!(JOBOBS::Char, COMPQ::Char, COMPZ::Char, N::Integer,
    ...
    C::Array{Float64,1}, LDC::AbstractFloat,
    Q::Array{Float64,1}, LDQ::AbstractFloat,
    Z::Array{Float64,1}, LDZ::AbstractFloat, NOBSV::Integer,
    ...
    ccall((:tg01id_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
            Ptr{Float64}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
...
function tg01jd!(JOB::Char, SYSTYP::Char, EQUIL::Char, N::Integer,
    ...
    B::Array{Float64,2}, LDB::Integer,
    C::Array{Float64,2}, LDC::Integer, NR::Integer,
    INFRED::Array{BlasInt,1}, TOL::AbstractFloat,
    IWORK::Array{BlasInt,1}, DWORK::Array{Float64,1},
    LDWORK::Integer)

    INFO = BlasInt[0]

    ccall((:tg01jd_, libslicotpath), Void, (Ptr{Char}, Ptr{Char},
            Ptr{Char}, Ptr{BlasInt}, Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt},
...
function tg01wd!(N::Integer, M::Integer, P::Integer,
    ...
    ccall((:tg01wd_, libslicotpath), Void, (Ptr{BlasInt}, Ptr{BlasInt},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{BlasInt}, Ptr{Float64},
            Ptr{BlasInt}, Ptr{Float64}, Ptr{Float64}, Ptr{Float64},
